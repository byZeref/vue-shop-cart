<template>
    <div class="mt-10 relative z-10">
        <div class="panel border rounded-sm border-sky-500">
            <h3 class="panel_title font-semibold text-sky-500 text-lg uppercase absolute px-2 ml-4 z-30 bg-white">
                Carrito
            </h3>
                ...
                <table class="w-full text-sm text-left">
                    ...
                    <tbody>
                        ...
                        <tr class="text-base">
                            ...
                            <td class="uppercase font-semibold py-2 md:p-2">${{ totals.tot_monto.toFixed(2) }}</td>
                            <td class="py-2 md:p-2 text-sm">
                                <button @click="$emit('clear_cart')" class="btn btn-error btn-xs md:btn-sm text-xs">
